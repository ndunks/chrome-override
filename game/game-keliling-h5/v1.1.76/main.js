(function () {
    ...
    function boot () {
        ...
        function setLoadingDisplay () {
            ...
            var progressPercent = splash.querySelector('.progress-bar div.loading-percent');
            cc.loader.onProgress = function (completedCount, totalCount, item) {
                var _isInvalid = completedCount === 1 && completedCount === totalCount;
                var percent = 100 * completedCount / totalCount;
                if (progressBar && !_isInvalid) {
                    progressBar.style.width = percent.toFixed(2) + '%';
                }
                if(progressPercent && !_isInvalid) {
        ...
        var option = {
            ...
            debugMode: cc.DebugMode.INFO,// : cc.DebugMode.ERROR,
